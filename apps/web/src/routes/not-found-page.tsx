  ...
  return (
    <main className="relative flex flex-1 flex-col px-8 pb-10 md:px-16 md:pb-14 lg:px-24 lg:pb-16 2xl:px-32 2xl:pb-20">
      <section className="mt-20 flex-1 md:mt-28 lg:mt-32">
        ...
        <h1 className="mt-6 animate-in font-display text-[clamp(3.75rem,9.5vw,16rem)] leading-[0.86] font-semibold tracking-[-0.035em] delay-100 duration-700 fill-mode-both fade-in slide-in-from-bottom-3">
          Not found
          <span className="text-primary">.</span>
        </h1>

        <p className="mt-10 max-w-2xl animate-in text-base leading-relaxed text-muted-foreground delay-200 duration-700 fill-mode-both fade-in slide-in-from-bottom-3 md:text-lg lg:text-xl">
